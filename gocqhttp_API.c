...
send_private_msg_data* New_send_private_msg(unsigned long user_id, unsigned long group_id, char message[1500], int auto_escape)
{
...
send_group_msg_data* New_send_group_msg(unsigned long group_id, char message[1500], int auto_escape)
{
